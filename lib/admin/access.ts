...
export const ADMIN_ONLY_RESOURCES = new Set(["users", "plans", "coupons", "paymentAccounts", "blogPosts", "studyCountries", "learningResources", "testimonials", "teachers", "communityCategories"]);
